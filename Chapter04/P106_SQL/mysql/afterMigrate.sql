...
values ('1', 'San Francisco', '+1 650 219 4782', '100 Market Street', 'Suite 300', 'CA', 'USA', 'AZ934VB', 'NA', 90000),
       ...
       ('15', 'Springfield', '+1 0009 9000 777', '155 Market Place', 'Suite 107', 'MA', 'USA', 'XX521SS', 'NA',
        55000) ON DUPLICATE KEY
UPDATE `office_code`=`office_code`;
...
values ('1', 'Advertising', '-int 4782', '1333', '1', 'publicity, promotion', NULL, NULL, NULL, NULL, NULL, NULL, NULL,
        NULL, NULL),

       ('2', 'Sales', '-int 41233', '1441', '1', 'commerce, trade, sellout, transaction', 650000, 900000, 800000, 20000,
        NULL, 10000, NULL, NULL, NULL),

       ('3', 'Accounting', '-int 8233', '2311', '2', 'monetary, business', NULL, 450000, NULL, 25000, NULL, NULL, NULL,
        NULL, NULL),

       ('4', 'Finance', '-int 4421', '3229', '3', 'commerce, fiscal, monetary, business', 120000, 90000, NULL, NULL,
        NULL, NULL, 40000, 10000, NULL),

       ('5', 'Sales', '-int 34443', '6554', '2', 'commerce, sellout, transaction', 345000, 350000, 450000, 11000, 25000,
        5000, 10000, 85000, 12000),

       ('6', 'Sales', '-int 7664', '1234', '4', NULL, NULL, 100000, NULL, NULL, NULL, NULL, 50000, NULL, NULL),

       ('7', 'Marketing', '-int 1266', '9090', '4', 'market, research, advertising', NULL, 500000, 250000, NULL, 11000,
        NULL, 5000, NULL, 1000),

       ('8', 'Marketing', '-int 4543', '4544', '5', 'market, research, advertising', NULL, 430000, 900000, NULL, NULL,
        NULL, NULL, NULL, NULL),

       ('9', 'Assembly', '-int 8777', '5455', '6', 'gathering, construction, joining', 500000, 500000, 450000, NULL,
        NULL, NULL, 7000, NULL, NULL),

       ('10', 'Accounting', '-int 6765', '4555', '6', 'monetary, business', NULL, NULL, 100000, 10000, NULL, NULL, 4000,
        NULL, NULL),

       ('11', 'Finance', '-int 1111', '7876', '7', 'commerce, fiscal, monetary, business', 450000, NULL, 450000, NULL,
        NULL, NULL, NULL, NULL, NULL),

       ('12', 'Logistics', '-int 4421', '3222', '8', 'facilities, supplies', NULL, 120000, 300000, 10000, NULL, 11000,
        NULL, 16000, NULL),

       ('13', 'Logistics', '-int 7453', '7884', '9', 'facilities, supplies', NULL, 80000, 100000, 9000, NULL, 6000,
        2300, 4400, NULL),

       ('14', 'Logistics', '-int 3433', '6777', '12', 'facilities, supplies', 235000, 233000, NULL, NULL, NULL, 1000,
        NULL, NULL, 9000),

       ('15', 'HR', '-int 2323', '7888', '12', 'people, interview, hiring', NULL, 120000, 120000, NULL, 544, NULL, NULL,
        2300, NULL) ON DUPLICATE KEY
...
values ('1', '1'),
       ...
       ('7', '2') ON DUPLICATE KEY
UPDATE `offices_office_code`=`offices_office_code`;
...
values (1002, 'Murphy', 'Diane', 'x5800', 'dmurphy@classicmodelcars.com', '1', 120000, 10000, NULL, 'President', NULL,
        '450, 210, 222, 123, 110, 0, 0, 0, 560, 440, 315, 125, 0, 900'),
       ...
       (1076, 'Firrelli', 'Jeff', 'x9273', 'jfirrelli@classicmodelcars.com', '1', 100000, 3500, 1002, 'VP Marketing',
        NULL, '0, 0, 0, 125, 125, 150, 232, 100, 0'),

       (1088, 'Patterson', 'William', 'x4871', 'wpatterson@classicmodelcars.com', '6', 80000, NULL, 1056,
        'Sales Manager (APAC)', NULL, '560, 120, 440, 320, 315, 0, 0, 100, 125, 0, 900'),
       ...
       (1401, 'Castillo', 'Pamela', 'x2759', 'pcastillo@classicmodelcars.com', '4', 55000, NULL, 1102, 'Sales Rep',
        '2000, 2001, 2003, 2005', NULL),

       (1501, 'Bott', 'Larry', 'x2311', 'lbott@classicmodelcars.com', '7', 50000, 1000, 1102, 'Sales Rep', '2004, 2008',
        NULL),
       ...
       (1612, 'Marsh', 'Peter', 'x102', 'pmarsh@classicmodelcars.com', '6', 55000, NULL, 1088, 'Sales Rep',
        '2003, 2005, 2006, 2007', NULL),

       (1619, 'King', 'Tom', 'x103', 'tking@classicmodelcars.com', '6', 60000, 1000, 1088, 'Sales Rep', '2002, 2004',
        NULL),

       (1621, 'Nishi', 'Mami', 'x101', 'mnishi@classicmodelcars.com', '5', 55000, 2000, 1056, 'Sales Rep', '2003, 2005',
        NULL),
       ...
       (1702, 'Gerard', 'Martin', 'x2312', 'mgerard@classicmodelcars.com', '4', 50000, 3400, 1102, 'Sales Rep',
        '2005, 2007', NULL) ON DUPLICATE KEY
UPDATE `employee_number`=`employee_number`;
...
values (99, 'Australian Home', 'Paoule', 'Sart ', '40.11.2555', 1370, '21000.00', 20210),
       ...
       (496, 'Kelly''s Gift Shop', 'Snowden', 'Tony', '+64 9 5555500', 1612, '110000.00', 20142) ON DUPLICATE KEY
...
values (99, '43 Rue 2', NULL, 'Paris', NULL, '25017', 'France'),
       ...
       (496, 'Arenales 1938 3''A''', NULL, 'Auckland ', NULL, NULL, 'New Zealand') ON DUPLICATE KEY
UPDATE `customer_number`=`customer_number`;
...
UPDATE `product_line`=`product_line`;
...
values ('Classic Cars', 599302, '200A', 1),
       ...
       ('Vintage Cars', 223113, '1000A', 3) ON DUPLICATE KEY
UPDATE `product_line`=`product_line`;
...
values (1, '1969 Harley Davidson Ultimate Chopper', 'Motorcycles', 599302, '1:10', 'Min Lin Diecast', 'PENDING', 7933,
       ...
       (110, 'Pont Yacht', 'Ships', 433823, '1:72', 'Unimax Art Galleries',
        ...
        414, '33.30', '54.60') ON DUPLICATE KEY
...
values (10100, '2003-01-06', '2003-01-13', '2003-01-10', 'Shipped', NULL, 363, 301.84),
       ...
       (10425, '2005-05-31', '2005-06-07', NULL, 'In Process', NULL, 119, 1231.98) ON DUPLICATE KEY
...
values (10100, 23, 30, '136.00', 3),
       ...
       (10425, 94, 18, '94.92', 2) ON DUPLICATE KEY
UPDATE `orderdetail_id`=`orderdetail_id`;
...
values (103, 'HQ336336', '2004-10-19 12:00:01', '6066.78', '2004-10-19 12:30:15'),
       ...
       (496, 'MN89921', '2004-12-31 09:02:11', '52166.00', '2004-12-31 09:02:11') ON DUPLICATE KEY
UPDATE `customer_number`=`customer_number`;
...
values (1, 2003, 5282.64, 1370, 1, 0, 'CONSTANT'),
       ...
       (25, 2005, 52343.12, 1102, 5, 947.57, 'UP') ON DUPLICATE KEY
...
values (40, '1992 Ferrari 360 Spider red'),
       ...
       (2, '1952 Alpine Renault 1300') ON DUPLICATE KEY
UPDATE `product_id`=`product_id`;
...
values (1, 1002, 'REGULAR', '2004-04-14'),
       ...
       (40, 1702, 'AVERAGE', '2004-09-02') ON DUPLICATE KEY
UPDATE `id`=`id`;
...
values (1, '2004-01-01', 21, 3373, 0.62),
       ...
       (10, '2004-01-10', 50, 1722, 2.90) ON DUPLICATE KEY
...
values ('Paris', 'Los Angeles', 9080),
       ...
       ('Tokyo', 'London', 9559) ON DUPLICATE KEY
UPDATE `depart_town`=`depart_town`;
