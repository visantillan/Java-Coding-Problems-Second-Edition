...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            /*
            // Alternatively to the reinterpret() method we can use withTargetLayout().
            AddressLayout intPointerLayout = ValueLayout.ADDRESS.withTargetLayout(ValueLayout.JAVA_INT);
            MemorySegment sgaddr1 = MemorySegment.ofAddress(addr1.address()).get(intPointerLayout, 0);
            System.out.println(sgaddr1.get(ValueLayout.JAVA_INT, 0));
            */
