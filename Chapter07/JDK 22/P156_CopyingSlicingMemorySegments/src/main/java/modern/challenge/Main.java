...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try (Arena arena = Arena.ofConfined()) {
            MemorySegment srcSegment = arena.allocateFrom(
            ...
            MemorySegment dstSegment1 = arena.allocate(ValueLayout.JAVA_INT, 8);
            ...
            MemorySegment dstSegment2 = arena.allocate(ValueLayout.JAVA_INT, 16);
        ...
        try (Arena arena = Arena.ofConfined()) {
            ...
            MemorySegment segment = arena.allocateFrom(ValueLayout.JAVA_INT,
